...
public class Nether {
    ...
    public void size16() {
        randomChunkGen(MCVersion.v1_13, 541515181818L, Dimension.NETHER, 16, 8312312322222L, size16);
    }

    @Test
    @DisplayName("Test Height map version 1.13 heightmap")
    public void column() {
        BiomeSource bs = BiomeSource.of(Dimension.NETHER, MCVersion.v1_13, 541515181818L);
    ...
    @Test
    @DisplayName("Test Height map version 1.13 heightmap 2")
    public void column2() {
        BiomeSource bs = BiomeSource.of(Dimension.NETHER, MCVersion.v1_13, 541515181818L);
        TerrainGenerator cg = TerrainGenerator.of(Dimension.NETHER, bs);
        assert cg != null;
