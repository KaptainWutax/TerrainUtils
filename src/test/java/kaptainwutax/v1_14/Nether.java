...
public class Nether {
    ...
    public void size16() {
        randomChunkGen(MCVersion.v1_14, 541515181818L, Dimension.NETHER, 16, 8312312322222L, size16);
    }

    @Test
    @DisplayName("Test Height map version 1.14 heightmap")
    public void column() {
        BiomeSource bs = BiomeSource.of(Dimension.NETHER, MCVersion.v1_14, 541515181818L);
    ...
    @Test
    @DisplayName("Test Height map version 1.14 heightmap 2")
    public void column2() {
        BiomeSource bs = BiomeSource.of(Dimension.NETHER, MCVersion.v1_14, 541515181818L);
        ChunkGenerator cg = ChunkGenerator.of(Dimension.NETHER, bs);
        assert cg != null;
