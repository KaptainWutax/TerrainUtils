...
public class Overworld {
    ...
    public void size16() {
        randomChunkGen(MCVersion.v1_14, 541515181818L, Dimension.OVERWORLD, 16, 4227552225777L, size16);
    }

    @Test
    @DisplayName("Test Height version 1.14 map size 32")
    public void size32() {
        randomChunkGen(MCVersion.v1_14, 541515181818L, Dimension.OVERWORLD, 32, 21382138983289132L, size32);
    }
